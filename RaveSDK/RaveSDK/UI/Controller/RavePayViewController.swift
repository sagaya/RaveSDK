...
public class RavePayViewController: UITableViewController {
    ...
    let navBarHeight:CGFloat = ((UIApplication.shared.delegate)!.window?!.safeAreaInsets.bottom)!
...
//            zenithBankButton.isEnabled = false
    ...
    override public func tableView(_ tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        ...
        switch section {
            ...
            case 2:
                return RaveConfig.sharedConfig().country == "NG" || RaveConfig.sharedConfig().country == "US" ? 65 : 0
            case 3:
...
extension RavePayViewController : UITextFieldDelegate,RavePayWebProtocol,UIPickerViewDelegate,UIPickerViewDataSource,CardSelect {
    ...
    @objc func toggleSaveCardCheck(){
        ...
        let image =  raveCardClient.saveCard == true ? UIImage(named: "rave_check_box", in: Bundle(for: RavePayViewController.self), compatibleWith: nil) :  UIImage(named:"rave_unchecked_box", in: Bundle(for: RavePayViewController.self), compatibleWith: nil)
    ...
    func showAccountFormScreen(withBackGround backgroundColor:String = "#f2f2f2", imageName:String = "", dobFieldHidden:Bool = true, bvnFieldHidden:Bool = true ){
        ...
        UIView.animate(withDuration: 0.6, animations: {
            ...
            self.accountImageView.image = UIImage(named: imageName, in: Bundle(for: RavePayViewController.self), compatibleWith: nil)
